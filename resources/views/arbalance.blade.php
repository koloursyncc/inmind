...
<html lang="en">
  ...
  <body>
      ...
      <div class="page-wrapper">
        <div class="page-content">
          ...
          <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">AR Balance Checker
            </div>
            <div class="ps-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">AR Balance Checker 
                  </li>
                </ol>
              </nav>
            </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4" style="margin-top:20px">
                        <div class="form-check form-check-inline">
                          ...
                          <select class="form-select mb-3" name="cust_name" id="cust_name" onchange="getusersreports()" aria-label="Default select example" >
                            <option value="">Select Customer Name</option>
                            @if($cust->count() > 0)
                                @foreach($cust as $c)
                                    <option value="{{ $c->po_id }}">{{ $c->name }}
                                    </option>    
                            @endForeach
                            @else
                             No Record Found
    ...
    function getreports(){
      ...
      window.location.href = "/arbalancechecker?po_id="+inv_id;
    }
    function getporeports(){
      var pv_id = $("#po_no_id").val();
      window.location.href = "/arbalancechecker?po_id="+pv_id;
    }
     function getusersreports(){
      var cu_id = $("#cust_name").val();
      window.location.href = "/arbalancechecker?po_id="+cu_id;
    }
    </script>
    <script>
