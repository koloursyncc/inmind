      ...
      <div class="page-wrapper">
        <div class="page-content">
          ...
          <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Inventory In
            </div>
            <div class="ps-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Inventory In
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div class="col-xl-12 ">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row g-3">
                  <div class="col-sm-4">
                   <p>Receiving Date: 04/11/2022</p>
                  </div>
                  <div class="col-sm-4">
                   <p>Inventory In Ticket ID: MVI 200/2565</p>
                  </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio"   name="type_of_customer"  type="radio" value="1">
                            <label class="form-check-label" for="inlineRadio1">Supplier PO
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                    ...
                    <div class="col-sm-4">
                        ...
                        <label class="form-check-label" for="inlineRadio1">No.</label>
                            <select class="form-select mb-3" name="brand_id" aria-label="Default select example" >
                                <option value="">Select Supplier PO No.
                                </option>
                ...
                <div class="row g-3">
                  <div class="col-sm-4">
                    <label for="inputFirstName" class="form-label">Delivery Ticket No.
                    </label>
